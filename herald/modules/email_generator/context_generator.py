...
# synops images are also added to cdn, but not used in emails yet
# 'background': 'https://cdn.hystax.com/synops/email-header-background.png'
# 'logo_new': 'https://cdn.hystax.com/SynOps/email-images/logo-new.png'
# 'logo_synops_beta_white': 'https://cdn.hystax.com/SynOps/email-images/logo-synops-beta-white.png'
# 'synops_mlops': 'https://cdn.hystax.com/SynOps/email-images/synops-mlops-capabilities.png'
# 'synops_banner': 'https://cdn.hystax.com/SynOps/email-images/synops-welcome-banner.png'
...
def _relevant_image_name(event_type):
    circle_grey_url = "https://cdn.hystax.com/SynOps/email-images/circle-grey.png"
    return {
        "INFO": circle_grey_url,
        "SUCCESS": "https://cdn.hystax.com/SynOps/email-images/circle-green.png",
        "WARNING": "https://cdn.hystax.com/SynOps/email-images/circle-yellow.png",
        "ERROR": "https://cdn.hystax.com/SynOps/email-images/triangle-red.png",
        "customer": "https://cdn.hystax.com/SynOps/email-images/users.png",
        "cloudsite": "https://cdn.hystax.com/SynOps/email-images/cloud.png",
        "device": "https://cdn.hystax.com/SynOps/email-images/desktop.png",
        "agent": "https://cdn.hystax.com/SynOps/email-images/shield.png",
...
def get_default_context():
    return {
        "images": {
            "logo": "https://cdn.hystax.com/SynOps/SynOps-logo-white.png",
            "telegram": "https://cdn.hystax.com/SynOps/email-images/telegram.png",
            "synops_ml_banner": "https://cdn.hystax.com/SynOps/email-images/synops-ml-welcome-banner.png",
            "synops_finops": "https://cdn.hystax.com/SynOps/email-images/synops-finops-capabilities.png",
        },
        "texts": {
            "product": "Hystax SynOps",
        ...
        "links": {
            ...
            "documentation": "https://hystax.com/documentation/synops",
            "background_image": "https://cdn.hystax.com/SynOps/email-header-background.png",
            "e2e_azure": "https://hystax.com/documentation/synops/e2e-guides/e2e-azure.html",
            "e2e_aws": "https://hystax.com/documentation/synops/e2e-guides/e2e-aws.html",
            "e2e_gcp": "https://hystax.com/documentation/synops/e2e-guides/e2e-gcp.html",
            "e2e_alibaba": "https://hystax.com/documentation/synops/e2e-guides/e2e-alibaba.html",
            "e2e_k8s": "https://hystax.com/documentation/synops/e2e-guides/e2e-kubernetes.html",
        },
    }
