...
1. Find an email template file you want to change in [synops](https://github.com/synycs-dev/extract_linked_reports/blob/main/herald/modules/email_generator/templates) sources.
