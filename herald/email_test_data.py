EMAIL_TEST_DATA = {
    "alert": {
        ...
        "subject": "SynOps Pool limit alert",
        "template_type": "alert",
        "template_params": {
            "texts": {
                "organization": {
    ...
    "employee_greetings": {
        ...
        "subject": "Thank you for registering at SynOps. Please proceed with the setup",
    ...
    "invite": {
        "email": ["me@1.com"],
        "subject": "SynOps invitation notification",
    ...
    "new_cloud_account": {
        "email": ["synops-staging-notifications@hystax.com"],
    ...
    "pool_exceed_report": {
        ...
        "subject": "Action Required: Hystax SynOps Pool Limit Exceed Alert",
    ...
    "pool_owner_violation_report": {
        ...
        "subject": "Action required: Hystax SynOps Resource Constraints Report",
    ...
    "resource_owner_violation_alert": {
        ...
        "subject": "Action required: Hystax SynOps Resource Constraint Violation Alert",
        "template_params": {
            "texts": {
                "total_violated": 2,
                "organization": {
    ...
    "weekly_expense_report": {
        ...
        "subject": "SynOps weekly expense report",
        "template_params": {
            "texts": {
                "organization": {
                    "forecast": 482.32,
    ...
    "first_shareable_resources": {
        "email": ["azaza@ma.il"],
        "subject": "SynOps shared environments notification",
    ...
    "restore_password": {
        ...
        "subject": "SynOps password recovery",
    ...
    "verify_email": {
        "email": ["serviceuser@hystax.com"],
        "subject": "SynOps email verification",
