...
import synops_client.herald_client.client
import synops_client.herald_client.client_v2
...
class TestHeraldBase(tornado.testing.AsyncHTTPTestCase):
    ...
    @patch("synops_client.config_client.client.Client")
    ...
    def setUp(self, p_consumer, p_config):
        ...
        http_provider = synops_client.herald_client.client.FetchMethodHttpProvider(self.fetch, rethrow=False)
        http_provider.token = "token"
        http_provider.secret = secret

        self.client = synops_client.herald_client.client.Client(http_provider=http_provider)
        self.client_v2 = synops_client.herald_client.client_v2.Client(http_provider=http_provider)
