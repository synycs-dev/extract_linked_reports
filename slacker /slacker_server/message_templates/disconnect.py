...
def get_disconnected_message(user_email, public_ip):
    ...
    return {
        "text": "You have disconnected your SynOps account "
        ...
        "blocks": [
            ...
            },
            {
                ...
                "text": {
                    "type": "mrkdwn",
                    "text": "You are still able to use SynOps using Web UI "
...
def get_disconnect_confirmation_message(user_email, public_ip):
    italic_user_email = '_{}_'.format(user_email)
    return {
        "text": "You are about to disconnect your SynOps "
        ...
        "blocks": [
            ...
            },
            {
                ...
                "text": {
                    "type": "mrkdwn",
                    "text": "You will still able to use SynOps using Web UI "
                            f"at <https://{public_ip}/>"
                }
            },
            {
